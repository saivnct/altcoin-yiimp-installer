...
################################################################################
    ...
    php7.3-recode php7.3-sqlite3 php7.3-tidy php7.3-xmlrpc php7.3-xsl memcached php-memcache php7.3-memcache php7.3-memcached php-imagick php-gettext php7.3-zip php7.3-mbstring
    ...
    # Compil Blocknotify
    cd ~
    hide_output git clone https://github.com/saivnct/altcoin-yiimp
